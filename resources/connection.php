<?php
  ...
  //educator login
	if(isset($_POST['educator'])){
		$teacher = stripslashes(mysql_real_escape_string($_POST['teacher']));
		$pswd = stripslashes(mysql_escape_string($_POST['pswd']));
		...
		if (mysqli_num_rows($result) == 1 ) {
			...
			header('location: add_resources2.php');
		}else{
    ...
    if(isset($_POST['upload_file'])){
      ...
      $location = 'resources/files/'.$newFileName;
