...
<div class="container"> 
    <h1 class="system-head">Class Notes Uploads System</h1>
    <div id="sign-up-image">
		<img src="images/profile.png" class="img-responsive" alt="Responsive image">
	</div>
	<form class="form-signin" method="POST" action="add_notes.php">
            ...
            <button class="btn btn-lg btn-primary btn-block" type="submit" name="notes">Login</button>
	</form>	
</div>
